...
#        "font-family": "msyh.ttf",
        ...
        "copyright": u"欢迎大家关注中东安协公众号，提交失物相关信息。",
...
def test():
    allfiles = os.listdir("text_pics")
    #print allfiles
    #print str(allfiles[5])
    for i in allfiles:
        if '.txt' in i:
            c = open("text_pics/"+str(i), "rb").read().decode("utf-8")
            txt2im(c, "text_pics/"+str(i) +'.png', show=True)
